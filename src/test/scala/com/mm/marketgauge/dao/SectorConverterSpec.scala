...
import com.mm.marketgauge.entities.SectorProperties.NAME
import com.mm.marketgauge.entities.SectorProperties.SECTORID
import com.mm.marketgauge.entities.SectorProperties.SOURCE
import com.mm.marketgauge.entities.SectorProperties.TICKER
  ...
  "The SectorConverter" - {
    "when calling convertToMongoObject with a Sector object " - {
      "should return a DbObject with all properties set" in {
        ...
        val testSector = new Sector(testName, testTicker, sectorId, source) 
